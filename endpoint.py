...
def train(model, train_loader, criterion, optimizer, device, batch_size, epochs):
...
def main(args):
    ...
    '''
    model=train(model, train_loader, loss_criterion, optimizer, device, batch_size, epochs)
